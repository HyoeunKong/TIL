...
async function create() {
        ...
        //couse.save().then(result=>console.log(result));
...
//Author.find().then(result => console.log(result)); //전체 담겨있는 모든 데이터를 불러온다.
//Course.find().then(result => console.log(result)); //전체 담겨있는 모든 데이터를 불러온다.
