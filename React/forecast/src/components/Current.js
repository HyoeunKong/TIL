        ...
        <>
            <section>
                ...
                <article className="contents text-muted">
                    <time>{`(${day[time.getDay()]}요일)`}{time.toLocaleTimeString()}</time>
            ...
            <section className='grid-contents'>
                <article className = "weather">
                    ...
                    <p className = "temparature">{unit === 'c'? Math.round(main.temp) : Math.round( (main.temp * 9) / 5 + 32 ) }</p>
                    <section className = "units">
                        <span className={unit === 'c' ? null : 'clickable'} onClick={unit === 'c' ? null : changeUnit}>°C</span>
                        <span> |</span>
                        <span className={unit === 'f' ? null : 'clickable'} onClick={unit === 'f' ? null : changeUnit}>°F</span>
                    </section>
                </article>
